...
const SignInPage = () => {
  ...
  const handleLogin = (event) => {
    ...
    if (email === 'elizabeth' && password === 'eliimylove') {
  ...
  return (
    <div>
      <div className="logo">
        <img src={irisLogo} alt="irisclane icon" style={{ width: '140px' }} />
      ...
      <div className="container">
        ...
        <form onSubmit={handleLogin}>
          ...
          <div>
            ...
            <a href="https://riyadh-mclane-v-datangel.github.io/sign-in//"><small>Sign Up</small></a>
          </div>
        </form>
      </div>
    </div>
